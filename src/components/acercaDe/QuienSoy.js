...
const QuienSoy = () => {
  return (
    <div className="quienSoy">
      <Container>
        <Row>
          <Col xs={12} sm={5} xl={3} className="quienSoy-pictureSide" >
          ...
          <Col xs={12} sm={7} className="quienSoy-paragraph d-xl-none">
            <QuienSoyCarousel />
          </Col>
          <Col className="d-xl">
        ...
        <p>
          ...
          <Col className="d-xl">        <h1 className="quienSoy-carousel-title">
          <AttentionSeeker effect="flash" delay={500} triggerOnce="true">
            <b> Water Mist Sevilla</b>
          </AttentionSeeker>
          <hr></hr>
